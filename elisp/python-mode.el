...
(defcustom py-shell-switch-buffers-on-execute nil
...
(if py-mode-map
  ...
  (define-key py-mode-map "\C-c\C-j"  'py-execute-region)
  ...
  (define-key py-mode-map "\M-H" 'py-mark-def-or-class)
...
(defun py-pdbtrack-track-stack-file (text)
  "Show the file indicated by the pdb stack entry line, in a separate windo.
